...
switch (process.env.BD_SELECCIONADA) {
    case 'archivo':
        const { default: CarritosDaosArchivo } = await import('./carritos/CarritosDaosArchivo.js');
        const { default: ProductosDaosArchivo } = await import('./productos/ProductosDaosArchivos.js');
        Producto = new ProductosDaosArchivo();
        Carrito = new CarritosDaosArchivo();
        break;
    case 'mongodb':
        const { default: CarritosDaosMongoDb } = await import('./carritos/CarritosDaosMongoDb.js');
    ...
    case 'firebase':
        ...
        const { default: CarritosDaosFirebase } = await import('./carritos/CarritosDaosFirebase.js');
        ...
        break;
    default:
        const { default: CarritosDaosMemoria } = await import('./carritos/CarritosDaosMemoria.js');
