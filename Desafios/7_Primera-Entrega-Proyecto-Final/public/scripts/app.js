...
async function productosGET() {
  ...
  for (let i = 0; i < respuesta.length; i++) {
    ...
    <h1>${respuesta[i].nombre}</h1>
    <p><strong>Agregado: </strong> ${respuesta[i].timestamp} </p>
    <img src="${respuesta[i].foto}" alt="">
    <p><strong>Descripción: </strong>${respuesta[i].descripcion}</p>
    <p><strong>ID de producto: </strong> ${respuesta[i].id} </p> 
    <p><strong>Referencia: </strong> ${respuesta[i].codigo} </p> 
    <p><strong>Existencia: </strong> ${respuesta[i].stock} </p> 
    `
...
async function productoGET(id) {
  ...
  let componente = `
    <div class='producto'>
      ...
      <p><strong>Agregado: </strong> ${respuesta.timestamp} </p>
      <img src="${respuesta.foto}" alt="">
      <p><strong>Descripción: </strong>${respuesta.descripcion}</p>
      <p><strong>ID de producto: </strong> ${respuesta.id} </p> 
      <p><strong>Referencia: </strong> ${respuesta.codigo} </p> 
      <p><strong>Existencia: </strong> ${respuesta.stock} </p> 
    </div>`
